				...
				<c:forEach var="v1" items="${list}">
					<div>
						...
						<c:forEach var="j" begin="1" end="${(v1.re_step-1)*5}">
							...
							<a href="/kgCoffee/voc/searchone.do?bunho=${v1.bunho}&voc_id=${v1.user_id}&searchKeywordType=${searchKeywordType }&searchKeyword=${searchKeyword }&page=${paging.page}"> ${v1.jemok}</a>
						</div>
