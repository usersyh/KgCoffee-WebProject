...
<link rel="stylesheet" href="/kgCoffee/css/sub_header.css?ver=1"
	type="text/css">
...
<body>
	...
	<div class="board_wrap">
		...
		<div class="board_title">
			<strong>
				<h3 align="center">종로 KG커피 공지사항</h3>
			</strong>
			...
			<div class="board_list">
				...
				<c:forEach var="v1" items="${alist1}">
					<div class="han_jul">
						...
						<%-- <div class="title"><a href="boardView.jsp"> ${v1.jemok}</a>
											</div> --%>
						<div class="title">
							<a class="jemok_a"
								href="/kgCoffee/board/searchone.do?bunho=${v1.bunho}&page=${paging.page}">
								${v1.jemok}</a>
						</div>
						<div class="writer">${v1.writer}</div>
						<%-- <div class="date">${v1.date}
									</div> --%>
						<div class="date">
